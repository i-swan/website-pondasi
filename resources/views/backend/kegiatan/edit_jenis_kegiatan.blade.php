                    ...
                    <div class="user-data">
                        <div class="row">
                        	<div class="col-lg-12 pl-5 pr-5">
		                        <form action="{{ url('/kegiatan/edit/jenis-kegiatan/simpan/'.$jenis_kegiatan->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
		                        	{{ csrf_field() }}
		                        	{{ method_field('POST')}}
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                    <input type="text"  name="nama_jenis" value="{{ $jenis_kegiatan->nama_jenis }}" placeholder="isi jenis kegiatan" class="form-control">
