...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('images_new/icon/favicon.ico') }}">
    <!-- all css here -->
    <link href="{{ asset('css_new/bootstrap.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/font-awesome.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/magnific-popup.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/slicknav.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/swiper.min.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/typography.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/default-css.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/styles.css') }}" rel="stylesheet" media="all">
    <link href="{{ asset('css_new/responsive.css') }}" rel="stylesheet" media="all">
    <!-- modernizr css -->
    <script src="{{ asset('js_new/vendor/modernizr-2.8.3.min.js') }}"></script>
</head>
...
<body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{ asset('images_new/icon/logo-white.png') }}" alt="logo">
                            </a>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="screen-slides-area">
                        <img src="{{ asset('images_new/mobile-screen/mobile-mockup.png') }}" alt="image">
                        <div class="screen-slides swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('images_new/mobile-screen/screens/screen1.jpg') }}" alt="image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('images_new/mobile-screen/screens/screen2.jpg') }}" alt="image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('images_new/mobile-screen/screens/screen3.jpg') }}" alt="image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('images_new/mobile-screen/screens/screen4.jpg') }}" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <div class="mscreen-right effectupdown">
                        <img src="{{ asset('images_new/mobile-screen/mobile-rotatescreen2.png') }}" alt="image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-5">
                    <div class="mscreen-left effectupdown2">
                        <img src="{{ asset('images_new/mobile-screen/mobile-rotatescreen1.png') }}" alt="image">
                    </div>
                </div>
                <div class="col-md-7">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="d-none d-lg-block col-lg-4 order-lg-1">
                    <div class="ft-device">
                        <img src="{{ asset('images_new/mobile-screen/mobile-mockup2.png') }}" alt="image">
                    </div>
                </div>
    ...
    <div class="screenshot-area bg-gray ptb--100">
        <div class="container">
            ...
            <div class="screenshot-carousel swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="{{ asset('images_new/mobile-screen/screens/screen1.jpg') }}" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('images_new/mobile-screen/screens/screen2.jpg') }}" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('images_new/mobile-screen/screens/screen3.jpg') }}" alt="screenshot">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{ asset('images_new/mobile-screen/screens/screen4.jpg') }}" alt="screenshot">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer trainer_s_three">
                        <div class="thumb">
                            <img src="{{ asset('images_new/team/team-img1.jpg') }}" alt="image">
                        </div>
                        <div class="content">
                            <h4>Rosa Dietrich</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer trainer_s_three">
                        <div class="thumb">
                            <img src="{{ asset('images_new/team/team-img2.jpg') }}" alt="image">
                        </div>
                        <div class="content">
                            <h4>Rosa Dietrich</h4>
                            <p>Body Builder Trainer</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-trainer trainer_s_three">
                        <div class="thumb">
                            <img src="{{ asset('images_new/team/team-img3.jpg') }}" alt="image">
                        </div>
                        <div class="content">
                            <h4>Rosa Dietrich</h4>
                            <p>Body Builder Trainer</p>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tst2-thumb">
                                    <img src="{{ asset('images_new/author/author-img1.jpg') }}" alt="image">
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="tst2-thumb">
                                    <img src="{{ asset('images_new/author/author-img2.jpg') }}" alt="image">
                                </div>
                                <div class="tst2-content">
                                    <h4>Franco Windler</h4>
                                    <span>Web Developer</span>
                            ...
                            <div class="swiper-slide">
                                <div class="tst2-thumb">
                                    <img src="{{ asset('images_new/author/author-img3.jpg') }}" alt="image">
                                </div>
                                <div class="tst2-content">
                                    <h4>Franco Windler</h4>
                                    <span>Web Developer</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 d-md-none d-lg-block d offset-lg-1">
                    <div class="faq-left-thumb">
                        <img src="{{ asset('images_new/mobile-screen/mobile-mockup3.png') }}" alt="image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog">
                        ...
                        <div class="blog-thumb">
                            <img src="{{ asset('images_new/blog/mobileapp-blog/mobileapp-blog-img3.jpg') }}" alt="">
                            <a href="blog.html" class="read-more">Read More
                                <i class="fa fa-long-arrow-right"></i>
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog">
                        ...
                        <div class="blog-thumb">
                            <img src="{{ asset('images_new/blog/mobileapp-blog/mobileapp-blog-img2.jpg') }}" alt="">
                            <a href="blog.html" class="read-more">Read More
                                <i class="fa fa-long-arrow-right"></i>
                            </a>
                        </div>
    ...
    <!-- others plugins -->
    <script src="{{ asset('js_new/jquery.slicknav.min.js') }}"></script>
    <script src="{{ asset('js_new/counterup.min.js') }}"></script>
    <script src="{{ asset('js_new/waypoints.js') }}"></script>
    <script src="{{ asset('js_new/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('js_new/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('js_new/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('js_new/countdown.js') }}"></script>
    <script src="{{ asset('js_new/swiper.min.js') }}"></script>
    <script src="{{ asset('js_new/plugins.js') }}"></script>
    <script src="{{ asset('js_new/jquery.zoomslider.min.js') }}"></script>
    <script src="{{ asset('js_new/jquery.firefly.js') }}"></script>
    <!-- google map -->
    ...
    <script src="{{ asset('js_new/scripts.js') }}"></script>
</body>
