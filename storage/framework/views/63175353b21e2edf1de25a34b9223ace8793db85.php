...
<!-- hero area start -->
<section class="hero-area app-slider pos-rel full-height d-flex align-items-center parallax" id="home" data-speed="3" data-bg-image="<?php echo e(asset('foto_background/home_new.jpg')); ?>">
        ...
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="mscreen-left effectupdown2">
                    <img src="<?php echo e(URL::to('/')); ?>/foto_member/g_600_470_3.jpg" alt="image">
                </div>
            </div>
            <div class="col-md-7">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-trainer trainer_s_three">
                    <div class="thumb">
                        <img src="<?php echo e(URL::to('/')); ?>/foto_member/<?php echo e($a->file_foto); ?>" alt="image" style="max-height: 600px">
                    </div>
                    <div class="content">
        ...
        <div class="row">
            <div class="appcta-content  appcta-right">
                <div class="links links-left">
                    <a class="active" href="<?php echo e(url('/member')); ?>">Lihat Semua Member</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="feature-blog ptb--100">
        <div class="container">
            ...
            <div class="row">
                <div class="appcta-content  appcta-right">
                    <div class="links links-left">
                        <a class="active" href="<?php echo e(url('/kegiatan-pondasi')); ?>">Lihat Semua Kegiatan Pondasi</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="screenshot-carousel swiper-container">
                <div class="swiper-wrapper">
                    <?php $__currentLoopData = $galeri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('foto_kegiatan/'.$g->file_foto)); ?>" alt="screenshot">
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="class-item">
                        <div class="thumb">
                            <img src="<?php echo e(URL::to('/')); ?>/foto_prestasi/<?php echo e($p->file_foto); ?>" alt="" style="max-height: 600px">
                        </div>
                        <div class="class-content">
                            ...
                            <a href="<?php echo e(url('/prestasi-pondasi/detail/'.$p->id)); ?>" class="join-class">Selengkapnya</a>
                            <ul class="meta-info">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-calendar"></i><?php echo e($p->tanggal); ?></a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-map-marker"></i><?php echo e($p->host); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pondasi\resources\views/frontend/index.blade.php ENDPATH**/ ?>