                                            ...
                                            <?php endif; ?>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="<?php echo e(url('/prestasi/restore/'.$a->id)); ?>">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Restore">
                                                                <i class="zmdi zmdi-refresh-sync"></i>
                                                            </button>
                                                        </a>
                                                        <a href="<?php echo e(url('/prestasi/hapus-permanen/'.$a->id)); ?>">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pondasi\resources\views/backend/prestasi/recycle_bin.blade.php ENDPATH**/ ?>