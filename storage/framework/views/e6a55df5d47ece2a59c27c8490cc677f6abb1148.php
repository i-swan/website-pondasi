                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="overview-wrap">
                                        ...
                                        <div>
                                            <a href="<?php echo e(url('/prestasi/tambah/jenis-prestasi')); ?>">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($jp->nama_jenis); ?></td>
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <a href="<?php echo e(url('/prestasi/edit/jenis-prestasi/'.$jp->id)); ?>">
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="zmdi zmdi-edit"></i>
                                                                </button>
                                                            </a>
                                                            <a href="<?php echo e(url('/prestasi/hapus/jenis-prestasi/'.$jp->id)); ?>">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pondasi\resources\views/backend/prestasi/jenis.blade.php ENDPATH**/ ?>