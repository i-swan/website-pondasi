                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="<?php echo e(url('/kegiatan/restore/'.$a->id)); ?>">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Restore">
                                                                <i class="zmdi zmdi-refresh-sync"></i>
                                                            </button>
                                                        </a>
                                                        <a href="<?php echo e(url('/kegiatan/hapus-permanen/'.$a->id)); ?>">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pondasi\resources\views/backend/Kegiatan/recycle_bin.blade.php ENDPATH**/ ?>