                    ...
                    <div class="user-data">
                        <div class="row">
                        	<div class="col-lg-12 pl-5 pr-5">
		                        <form action="<?php echo e(url('/kegiatan/tambah/simpan')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
		                                ...
		                                <div class="col col-md-9">
											...
											<?php $__currentLoopData = $jenis_kegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $jk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											    <label for="inline-radio1" class="form-check-label ">
											        <input type="radio" id="'inline-radio'.<?php echo e($jk->id); ?>" name="jenis_kegiatan_id" value="<?php echo e($jk->id); ?>"  class="form-check-input"> <?php echo e($jk->nama_jenis); ?>  &nbsp
											    </label>
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                	...
		                                	<?php if($errors->has('pj')): ?>
				                                <div  class="alert alert-danger" role="alert">
				                                    <?php echo e($errors->first('pj')); ?>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pondasi\resources\views/backend/kegiatan/tambah.blade.php ENDPATH**/ ?>