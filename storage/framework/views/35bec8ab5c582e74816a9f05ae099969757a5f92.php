                    ...
                    <div class="user-data">
                        <div class="row">
                        	<div class="col-lg-12 pl-5 pr-5">
		                        <form action="<?php echo e(url('/donasi/edit/simpan/'.$donasi->id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                    <input type="text"  name="nama" value="<?php echo e($donasi->nama); ?>" placeholder="ex Hamba Allah" class="form-control">
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                    <input type="text"  name="no_rek_asal" value="<?php echo e($donasi->no_rek_asal); ?>" placeholder="ex 0000" class="form-control">
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                    <input type="text"  name="jumlah" value="<?php echo e($donasi->jumlah); ?>" placeholder="ex 1000000 (tanpa titik)" class="form-control">
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
	                                		...
	                                		<?php $__currentLoopData = $jenis_rekening; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $jr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                                			<option value="<?php echo e($jr->id); ?>" <?php if($jr->id==$donasi->rekening_id): ?> selected="selected" <?php endif; ?>><?php echo e($jr->no_rek); ?>( <?php echo e($jr->nama); ?> )</option>
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9 input-group-date">
		                                	<div class='input-group date' id='datetimepicker1'>
			                                    <input type="text"  name="tanggal" value="<?php echo e($donasi->tanggal); ?>" placeholder="Tanggal donasi" class="form-control">
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                    <textarea name="keterangan" placeholder="keterangan" class="form-control"><?php echo e($donasi->keterangan); ?></textarea>
		                            ...
		                            <div class="row form-group">
		                                ...
		                                <div class="col-12 col-md-9">
		                                    <input type="file"  name="file_foto" value="<?php echo e($donasi->file_foto); ?>">
		                                    <img src="<?php echo e(URL::to('/')); ?>/foto_donasi/<?php echo e($donasi->file_foto); ?>" class="img-thumbnail" width="100">
		                                    <input type="hidden"  name="hidden_image" value="<?php echo e($donasi->file_foto); ?>">		                                    
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pondasi\resources\views/backend/donasi/edit.blade.php ENDPATH**/ ?>